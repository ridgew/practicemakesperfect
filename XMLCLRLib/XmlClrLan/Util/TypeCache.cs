...
namespace XmlClrLan
{
    ...
    {
        static readonly Dictionary<string, Type> FTD = new Dictionary<string, Type>(StringComparer.InvariantCultureIgnoreCase);
        ...
        static TypeCache()
        {
            FTD.Add("type", typeof(Type));
            FTD.Add("object", typeof(object));
        ...
        {
            string typeStr = ToSimpleType(type);
            return FTD.ContainsKey(typeStr);
        }
