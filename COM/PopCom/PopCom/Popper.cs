    ...
    class Popper : IDisposable
    {
        ...
        private void DeviceEvent(object sender, EventArrivedEventArgs e, bool insertion)
        {
            if ((insertion && enablePlugIn) || (!insertion && enablePlugOut))
            {
                ...
                /*
                  {71a27cdd-812a-11d0-bec7-08002be2092f} //系统卷总线
                  {eec5ad98-8080-425f-922a-dabf3de3f69a} //磁盘卷加载
                  {36fc9e60-c465-11cf-8056-444553540000} //USB大容量驱动
                  {4d36e967-e325-11ce-bfc1-08002be10318} //硬件设备接入
                 */
                ...
                //}
                System.Diagnostics.Debug.WriteLine(guid.ToString() + " " + instance.ClassPath.ClassName);
            }
        }
